 ...
 * it independently (if it's been leaked).
 *
 * These are SIGNUP-only codes. After signup + admin approval, each
 * prof gets a per-prof `loginPasskey` (Session E1a: onProfActivated
 * trigger) emailed to them. Returning profs use their personal
 * passkey to unlock the gate, not this school-wide code.
 *
